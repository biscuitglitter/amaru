...
const SelectMenu = () => {
  return (
    ...
    <select style={{width: "190px", fontSize: "14.5px", lineHeight: "18.78px"}} className="block py-2 px-3 border-none rounded-md shadow-sm focus:outline-none font-black cursor-pointer mb-3 bg-gray-100">
    {[
