...
const MainHeader = () => {
  return (
    <header className="flex flex-row justify-between h-16 bg-white border-0 border-b border-gray-300 py-5 items-center" style={{width: "100%"}}>
      ...
      <nav style={{width: "700px", minWidth: "600px"}} className="h-5 min-w-38 flex flex-row justify-around text-base font-black cursor-pointer text-sm leading-5 gap-3 mx-12">
        {[
          ["SALE", "/sale"],
